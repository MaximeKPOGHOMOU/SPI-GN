...
export class Home implements AfterViewInit {
  ...
  slides = [
    ...
    { title: 'Géolocalisation', subtitle: 'Gestion et Traçabilité', text: 'Nous proposons des solutions GPS pour vos véhicules et équipements, permettant un suivi précis et en temps réel.' },
